...
- (void)layoutSubviews {
    ...
    CGFloat btnHeight = btnWidth;//self.finishBtn.bounds.size.height+2*margin;
    CGFloat btnX = (self.bounds.size.width - btnWidth)/2;
    self.finishBtn.layer.cornerRadius = btnWidth/2.0;
    
    // 距离屏幕下方的距离为 100
    CGFloat btnY = self.bounds.size.height - 120.f - btnHeight;
